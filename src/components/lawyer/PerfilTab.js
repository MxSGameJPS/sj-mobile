...
export default function PerfilTab({ userId, accessToken }) {
    ...
    async (isRefresh = false) => {
      ...
      try {
        ...
        if (resData.success && resData.data) {
          ...
          setVerified(
            p.oab_verification_status === "VERIFIED" || p.verified || false,
          );
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      ...
      if (resData.success) {
        ...
        Alert.alert(
          "Erro",
          resData.message || "Não foi possível salvar o perfil.",
        );
      }
    } catch (e) {
  ...
  const handleCopyText = () => {
    ...
    Alert.alert(
      "Copiado",
      "Resumo profissional copiado para a área de transferência!",
    );
  };
  ...
  const handleDownloadImage = async (ref, label) => {
    ...
    try {
      ...
      try {
        ...
        console.warn(
          "[PerfilTab] Erro ao solicitar permissão da galeria:",
          permissionErr,
        );
      }
      ...
      Alert.alert(
        "Erro",
        `Não foi possível gerar a imagem do ${label.toLowerCase()}.`,
      );
    }
  };
    ...
    >
      ...
      <View style={styles.profileHeaderBox}>
        ...
        <View style={styles.accountDataBox}>
          ...
          <TouchableOpacity
            ...
            activeOpacity={0.8}
          >
            <Text style={styles.accountResetBtnText}>
              Alterar Particular na Conta
            </Text>
          </TouchableOpacity>
        </View>
      </View>
      ...
      <View style={styles.card}>
        ...
        >
          <Text style={styles.inputText}>
            {estado
              ? UF_OPTIONS.find((item) => item.value === estado)?.label ||
                estado
            ...
            return (
              <TouchableOpacity
                ...
                style={[
                  ...
                  isActive && styles.specialtyCardActive,
                ]}
      ...
      <View style={styles.card}>
        <View style={styles.consultaToggleRow}>
          <TouchableOpacity
            style={[
              styles.toggleBtn,
              consulta === "Gratuita" && styles.toggleBtnActive,
            ]}
            onPress={() => {
          ...
          >
            <Feather
              ...
              style={{
                marginRight: 6,
                opacity: consulta === "Gratuita" ? 1 : 0,
              }}
            />
            <Text
              style={[
                styles.toggleBtnText,
                consulta === "Gratuita" && styles.toggleBtnTextActive,
              ]}
            >
              Consulta Gratuita
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.toggleBtn,
              consulta === "Paga" && styles.toggleBtnActive,
            ]}
          ...
          >
            ...
            <Text
              style={[
                styles.toggleBtnText,
                consulta === "Paga" && styles.toggleBtnTextActive,
              ]}
            >
              Consulta Paga
            </Text>
        ...
        <View style={styles.digitalCardTop}>
          <View style={styles.digitalCardAvatarBorder}>
            {avatar ? (
              <Image
                source={{ uri: avatar }}
                style={styles.digitalCardAvatar}
              />
            ) : (
              ...
              {verified && (
                <View style={styles.digitalMiniBadgeGreen}>
                  <Feather
                    ...
                    style={{ marginRight: 2 }}
                  />
                  <Text style={styles.digitalMiniBadgeGreenText}>
                    OAB VERIFICADA
                  </Text>
                </View>
              )}
        ...
        <View style={styles.digitalCardContactList}>
          <View style={styles.digitalCardContactItem}>
            <Feather
              ...
              size={14}
              color="#f5c853"
              style={styles.digitalCardContactIcon}
            />
            <Text style={styles.digitalCardContactText}>
              {phone || "Celular não informado"}
            </Text>
          </View>
      ...
      <View style={styles.shareTextBox}>
        ...
        <Text style={styles.shareTextDesc}>
          Esse conteúdo resume seu perfil e pode ser enviado para potenciais
          clientes com estilo manual:
        </Text>
      ...
      <View style={styles.bottomBannerBox}>
        ...
        <View style={styles.shareActionsRow}>
          <TouchableOpacity
            ...
            onPress={() =>
              handleDownloadImage(cardRef, "Cartão de Visitas Digital")
            }
            activeOpacity={0.8}
          >
            <Feather
            ...
            >
              {UF_OPTIONS.map((item) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.modalItem,
                    estado === item.value && styles.modalItemActive,
                  ]}
                  onPress={() => {
                ...
                >
                  <Text
                    style={[
                      ...
                      estado === item.value && styles.modalItemTextActive,
                    ]}
                  >
                    {item.label}
                  </Text>
            ...
            >
              {DURATION_OPTIONS.map((opt) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.modalItem,
                    tempo === opt && styles.modalItemActive,
                  ]}
                  onPress={() => {
                    setTempo(opt);
                ...
                >
                  <Text
                    style={[
                      styles.modalItemText,
                      tempo === opt && styles.modalItemTextActive,
                    ]}
                  >
                    {opt}
                  </Text>
