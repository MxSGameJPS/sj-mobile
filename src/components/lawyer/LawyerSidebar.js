...
export default function LawyerSidebar({
  ...
  const checkFreeAccess = (featureName, callback) => {
    if (isFree) {
      onPlanPress(
        `A ferramenta "${featureName}" é exclusiva para assinantes dos planos START e PRO.\n\nGerencie sua assinatura no portal web para liberar o acesso.`,
      );
      return;
    }
    callback();
  ...
  const handleNotImplemented = (featureName) => {
    Alert.alert(
      "Recurso Web",
      `A ferramenta "${featureName}" está disponível exclusivamente no painel Web do SocialJurídico.`,
    );
  };
          ...
          >
            ...
            <View style={styles.menuSection}>
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  checkFreeAccess("Assinatura Digital", () => {
                    onClose();
                    navigation.navigate("LawyerDigitalSignature", {
                      user,
                      session,
                    });
                  });
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  checkFreeAccess("Blindagem de Provas", () => {
                    onClose();
                    navigation.navigate("LawyerBlindagemDashboard", {
                      user,
                      session,
                    });
                  });
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  if (isFree || isStart) {
                    onPlanPress(
                      'A "Calculadora Jurídica" é exclusiva para assinantes do Plano PRO.\n\nGerencie sua assinatura no portal web para liberar o acesso.',
                    );
                    return;
                  }
            ...
            <View style={styles.webResourcesBox}>
              ...
              <Text style={styles.webResourcesDesc}>
                As ferramentas IA SMART Docs, Redator IA, Triagem de Casos e
                Jurisprudência são exclusivas do painel Web.
              </Text>
            </View>
          </ScrollView>
          ...
          <View style={styles.footerSection}>
            ...
            <TouchableOpacity style={styles.footerItem} onPress={onLogout}>
              <Feather
                ...
                style={styles.menuIcon}
              />
              <Text style={[styles.footerItemText, { color: "#e53e3e" }]}>
                Sair
              </Text>
            </TouchableOpacity>
          </View>
